...
if [ $stage -le 13 ]; then
  ...
  relu-batchnorm-dropout-layer name=tdnn3 $opts dim=512 input=Append(-1,0,1)
  relu-batchnorm-dropout-layer name=tdnn4 $opts dim=512 input=Append(-3,0,3)
  relu-batchnorm-dropout-layer name=tdnn5 $opts dim=512 input=Append(-3,0,3)
  relu-batchnorm-dropout-layer name=tdnn6 $opts dim=512 input=Append(-6,-3,0)
