...
nnet3_affix=
skip_ivectors=true # we get an unexplained segfault, when training ivector extractor; setting to false should get better results
...
if $skip_ivectors; then stage=99; fi
